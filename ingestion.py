...
embeddings = OpenAIEmbeddings(model = "text-embedding-3-small") # can check with different embedding models
...
def ingest_docs():
    ...
    # Update document metadata for URL correction (this basically helps to display source link with response for each query)
